...
namespace RazorPagesDemo.Pages
{
    public class RollDiceModel : PageModel
    {
        public void OnGet()
        {
            DiceFaceValueImage = "img/icons/ffffff/000000/1x1/delapouite/dice-target.png";
        }
        ...
        public void OnPost()
        {
            ...
            {
                InfoMessage = $"Cogratulations, you won ${BetAmount}";
            }
            else
            {
                InfoMessage = $"I am happ but you lost {BetAmount:C}";
            }
        }
    }
}
